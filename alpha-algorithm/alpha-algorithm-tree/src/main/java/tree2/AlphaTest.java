...
public class AlphaTest {
    ...
    @Test
    public void test(){
        SysResourceVo node1 = new SysResourceVo(11L, 0, "aaaaaa", "一级资源", "http://xxxx");
        SysResourceVo node2 = new SysResourceVo(21L, 0, "bbbbbb", "一级资源", "http://xxxx");

        SysResourceVo node3 = new SysResourceVo(12L, 11, "cccccc", "二级资源", "http://xxxx");
        SysResourceVo node4 = new SysResourceVo(14L, 21, "dddddd", "二级资源", "http://xxxx");

        SysResourceVo node5 = new SysResourceVo(15L, 14, "eeeeeee", "四级资源", "http://xxxx");
        SysResourceVo node6 = new SysResourceVo(13L, 12, "ffffffff", "三级资源", "http://xxxx");
