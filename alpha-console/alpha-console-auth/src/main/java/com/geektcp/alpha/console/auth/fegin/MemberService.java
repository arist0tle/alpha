package com.geektcp.alpha.console.auth.fegin;

import com.geektcp.alpha.console.auth.vo.MemberVO;
import com.geektcp.alpha.console.auth.service.fallback.MemberServiceFallbackImpl;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;


@FeignClient(name = "alpha-mps", fallback = MemberServiceFallbackImpl.class)
