package com.geektcp.alpha.console.gateway.feign;


import com.geektcp.alpha.console.gateway.entity.vo.PermissionVO;
import com.geektcp.alpha.console.gateway.feign.fallback.RemotePermissionServiceFallbackImpl;
...
@FeignClient(name = "alpha-mps", fallback = RemotePermissionServiceFallbackImpl.class)
