...
//        String path = System.getProperty("user.dir") + File.separator + "conf" + File.separator + "es-example.properties";
        path = path.replace("\\", "\\\\");
...
//        String jaasPath = System.getProperty("user.dir") + File.separator + "conf" + File.separator + "jaas.conf";
    ...
    private static void bulk(RestClient restClientTest) {
        ...
        Long idNumber = 0L;
        Long oneCommit = 5L;//Please modify the number of index documents submitted in each loop according to actual needs.
        Long totalRecordNumber = 10L;//Please modify the total number of index documents that need to be submitted in this bulk request method according to actual needs.
