package com.geektcp.alpha.game.chess.view;

import alpha.common.base.util.FileUtils;
import com.geektcp.alpha.game.chess.chess.Board;
import com.geektcp.alpha.game.chess.chess.Piece;
import com.geektcp.alpha.game.chess.chess.Rules;
...
public class GameView {
    ...
    private static final String pathImg = FileUtils.getResourcePath() + "/img/";
    ...
    public void init(final Board board) {
        ...
        String pathIcon = pathImg + "icon.png";
        String pathBoard = pathImg + "board.png";
        String pathPlayer = pathImg + "r.png";
        frame.setIconImage(new ImageIcon(pathIcon).getImage());
        ...
        JLabel bgBoard = new JLabel(new ImageIcon(pathBoard));
        ...
        lblPlayer = new JLabel(new ImageIcon(pathPlayer));
        ...
        for (Map.Entry<String, Piece> stringPieceEntry : pieces.entrySet()) {
            ...
            JLabel lblPiece = new JLabel(new ImageIcon(pathImg + key.substring(0, 2) + ".png"));
    ...
    public void showPlayer(char player) {
        lblPlayer.setIcon(new ImageIcon(pathImg + player + ".png"));
        frame.setVisible(true);
    }
