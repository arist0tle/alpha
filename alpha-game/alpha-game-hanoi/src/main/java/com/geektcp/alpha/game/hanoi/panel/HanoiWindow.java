...
import com.geektcp.alpha.game.hanoi.panel.Tower;
...
public class HanoiWindow extends JFrame implements ActionListener {
    ...
    private int amountOfDisc = 6;
    private static char[] towerName = {'A', 'B', 'C'};
    private JMenuItem oneGradeItem, twoGradeItem, threeGradeItem;
    ...
    public HanoiWindow() {
        ...
        JMenu menuGrade = new JMenu("选择级别");
