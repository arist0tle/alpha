...
//            arangoUtitl.arangoGraph.addVertexCollection(vertextCollectionName2);
...

        {
            ...
            arangoUtitl.insertEdge(ecn, "vertex_tb_name/bob", "vertex_tb_name/dave");
            arangoUtitl.insertEdge(ecn, "vertex_tb_name/bob", "vertex_tb_name/charlie");
            arangoUtitl.insertEdge(ecn, "vertex_tb_name/alice", "vertex_tb_name/bob");
            arangoUtitl.insertEdge(ecn, "vertex_tb_name/eve", "vertex_tb_name/alice");
            arangoUtitl.insertEdge(ecn, "vertex_tb_name/eve", "vertex_tb_name/bob");
